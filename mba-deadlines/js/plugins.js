...
(function (angular, factory) {
            ...
            var pubMembers = {
                ...
                */
                ...
                open: function (prms) {
                    ...
                    dialogDefaults.dialogId = dialogId
                ...
                close: function (id, value, closeImmediateParent, closeAllDialogs) {
                    if (closeAllDialogs) {
                        ...
                        if (dialogObj.length < 1) dialogObj = angular.element(document.getElementById(dialogDefaults.dialogId));
                        closeDialog(dialogObj, value);
    ...
    psm.directive('draggable', ['$document', '$rootScope', function ($document, $rootScope) {
        ...
        return function (scope, element) {
            ...
            element.closest('.dialog-content').css({
                position: 'relative'
            });
